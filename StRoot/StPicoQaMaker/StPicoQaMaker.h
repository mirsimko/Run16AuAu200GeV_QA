...
//---Variables for TTree---------------------------
// add vaariables for Run16 QA - not used - will use histograms

//	Float_t TransverseMomentum, Eta, Phi, DCA, RefMult, gRefMult, Centrality; //add kinematic variables for HFT tracks?
//	Int_t mRunId, mNofTracks, mNofHFTTracks, mNEventsInRun;
